...
// This function guarantees a positive integer value is entered and returned. If a zero or a negative value is entered, an error message would be displayed.
...
int inputIntRange(int lowerBound, int upperBound)
{
    ...
    // Checks completed so now we can return the value
    return value;
}

// This function guarantees a single character value is entered within the list of valid characters and returned.
// If an entered character is not in the list of valid characters, display an error message and prompt again.
...
// Purpose of this function: display an array of 10-character digits as a formatted phone number.
